...
class AllSprites(pygame.sprite.Group):
	...
	def draw_sky(self):
		...
		sea_rect = pygame.FRect(0,horizon_pos,SCREEN_WIDTH,SCREEN_HEIGHT - horizon_pos)
		pygame.draw.rect(self.display_surface, '#92a9ce', sea_rect)

		# horizon line
		pygame.draw.line(self.display_surface, '#f5f1de', (0,horizon_pos), (SCREEN_WIDTH, horizon_pos), 4)
